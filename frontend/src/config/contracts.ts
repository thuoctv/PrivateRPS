...
export const CONTRACT_ADDRESS = '0x4D7ba125797dE59a9CE43D0C5CF0452531E9E08c';
...
export const CONTRACT_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: 'euint8',
        name: 'player1ChoiceHandle',
        type: 'bytes32',
      },
      {
        indexed: false,
        internalType: 'euint8',
        name: 'player2ChoiceHandle',
        type: 'bytes32',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: 'bytes',
        name: '_publicDecryptionProof',
        type: 'bytes',
      },
    ],
    name: 'finalizeGameReveal',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
